...
class Key:
    ...
    def create_trial_key(token, product_id, machine_code):
        ...
        try:
            response = HelperMethods.send_request(
                "key/createtrialkey",
                {"token": token, "ProductId": product_id, "MachineCode": machine_code},
            )
        except HTTPError as e:
            response = e.read()
        except URLError as e:
    ...
    def unblock_key(token, product_id, key):
        ...
        try:
            response = HelperMethods.send_request(
                "/key/UnblockKey", {"token": token, "ProductId": product_id, "Key": key}
            )
        except HTTPError as e:
            response = e.read()
        except URLError as e:
    ...
    def block_key(token, product_id, key):
        ...
        try:
            response = HelperMethods.send_request(
                "/key/BlockKey", {"token": token, "ProductId": product_id, "Key": key}
            )
        except HTTPError as e:
            response = e.read()
        except URLError as e:
...
class AI:
    ...
    @staticmethod
    def get_events(
        token, limit=10, starting_after=0, product_id=0, key="", metadata=""
    ):
...
class Message:
    ...
    def get_messages(token, channel="", time=0):
        ...
        try:
            response = HelperMethods.send_request(
                "/message/getmessages/",
                {"token": token, "Channel": channel, "Time": time},
            )
        except HTTPError as e:
            response = e.read()
        except URLError as e:
    ...
    def create_message(token, content="", channel="", time=0):
        ...
        try:
            response = HelperMethods.send_request(
                ...
                {"token": token, "Channel": channel, "Content": content, "Time": time},
            )
        except HTTPError as e:
            response = e.read()
        except URLError as e:
    ...
    def remove_message(token, messageId):
        ...
        try:
            response = HelperMethods.send_request(
                "/message/RemoveMessage/", {"token": token, "Id": messageId}
            )
        except HTTPError as e:
            response = e.read()
        except URLError as e:
...
class Product:
    ...
    def get_products(token):
        ...
        try:
            response = HelperMethods.send_request(
                "/product/getproducts/", {"token": token}
            )
        except HTTPError as e:
            response = e.read()
        except URLError as e:
...
class Data:
    ...
    @staticmethod
    def increment_int_value_to_key(
        token, product_id, key, object_id, int_value=0, enable_bound=False, bound=0
    ):
    ...
    @staticmethod
    def add_data_object_to_machine(
        token,
        product_id,
        key,
        machine_code,
        ...
        try:
            response = HelperMethods.send_request(
                "/data/AddDataObjectToMachineCode/",
                {
                    "token": token,
                    "ProductId": product_id,
                    "Key": key,
    ...
    @staticmethod
    def remove_data_object_to_machine(
        token, product_id, key, machine_code, object_id=0, name=""
    ):
        ...
        try:
            response = HelperMethods.send_request(
                "/data/RemoveDataObjectToMachineCode/",
                {
                    "token": token,
                    "ProductId": product_id,
                    "Key": key,
    ...
    @staticmethod
    def list_machine_data_objects(
        token, product_id, key, machine_code, name_contains=""
    ):
        ...
        try:
            response = HelperMethods.send_request(
                "/data/ListDataObjectsToMachineCode/",
                {
                    "token": token,
                    "ProductId": product_id,
                    "Key": key,
    ...
    @staticmethod
    def list_key_data_objects(token, product_id, key, name_contains=""):
...
class Helpers:
    ...
    @staticmethod
    def IsOnRightMachine(
        license_key,
        is_floating_license=False,
        allow_overdraft=False,
        v=1,
        custom_machine_code=None,
    ):
        return True
        ...
        if is_floating_license:
            for act_machine in license_key.activated_machines:
                if (
                    act_machine.Mid[9:] == current_mid
                    or allow_overdraft
                    and act_machine.Mid[19:] == current_mid
                ):
                    return True
        else:
            for act_machine in license_key.activated_machines:
